...
from Structure_Connector import Connector
from Structure_ConnectorView import ConnectorView
...
class Frame(QtWidgets.QFrame):
    def __init__(self, mwindow):
        ...
        clearA = QtWidgets.QAction('Clear Connectors', self)
        clearA.triggered.connect(self.removeAll)
        self.menu.addAction(clearA)

        clearallA = QtWidgets.QAction('Clear Frame', self)
